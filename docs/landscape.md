...
| 2026 | Self-Harness, Harness-R1, HarnessOpt-Bench, EvoHarness-RL, SHE, Evo-Bench, REDAgentBench, EnvACE, OpenForgeRL, A²E, ENPIRE, OpenETA, XPolicyLab, Guava, ASPIRE, GaP, Harness VLA, HarnessWAM, HyMeS, In-Context VLA, AtlasVLA, Physical Agency, RoboBRIDGE, Embodied Agents Take Control, HERO, CheckVLA, CoWAM, TempoWAM, SAFECAST, InternVLA-A1, LingBot-VLA 2.0, Qwen robotics models, TurboVLA, Robot-Factored World Models, World Action Models in Real Time, ω-0, GeniWorld, XEWorld, DynamicWAM, Flex-π, PSG-JEPA, Qwen-RobotWorld, ViTacWorld, World Action Planner, VisualPatchWorld, GAUGE, WorldSimProbe, VLA-Arena, RoboGraph, vla-evaluation-harness | The ecosystem began treating orchestration, memory, recovery, skill discovery, physical autoresearch, cross-embodiment schemas, asynchronous serving, runtime verification, planner-facing world models, physical-fidelity diagnosis, evaluation, and the harness itself as optimization targets. |
...
| World-model planning and interaction | V-JEPA 2-AC, DreamerV3, Robot-Factored World Models, Qwen-RobotWorld, ViTacWorld, GeniWorld, World Action Planner, VisualPatchWorld, DynamicWAM, Flex-π, HarnessWAM | Predicts consequences and supports explicit planning, interactive rollouts, augmentation, policy evaluation, deliberation, recovery, configurable future streams, or inspectable executable dynamics. | Model bias, conditioning leakage, geometry/calibration drift, code validity, artifact availability, and planning budget. |
...
| Harness optimization | Self-Harness, Harness-R1, HarnessOpt-Bench, EvoHarness-RL, SHE, Evo-Bench, EnvACE, OpenForgeRL, A²E | Trace-grounded, model-specific changes proposed or learned around a fixed target, with budgeted evaluation and auditable candidate selection; safety-attributed evolution; training-time world rehearsal; or training and auditing infrastructure for harness-native agents. | Evaluation leakage, same-batch reward overfitting, search cost, unsafe editable surfaces, and rollback. |
| Executable and perception-threat audit | REDAgentBench, Hijacking Robots with a Piece of Paper | Verifies digital-agent effects from service state and evaluates physical prompt injection against VLM-controlled robots. | Digital-to-physical transfer, attack-transfer assumptions, defense trade-offs, artifact availability, and no independent benchmark replication yet. |
