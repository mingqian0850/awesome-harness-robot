...
| 2026 | Self-Harness, Harness-R1, HarnessOpt-Bench, EvoHarness-RL, EnvACE, ENPIRE, OpenETA, Guava, ASPIRE, GaP, Harness VLA, In-Context VLA, Physical Agency, RoboBRIDGE, Embodied Agents Take Control, HERO, CheckVLA, CoWAM, SAFECAST, InternVLA-A1, LingBot-VLA 2.0, Qwen robotics models, TurboVLA, Robot-Factored World Models, World Action Models in Real Time, ω-0, GeniWorld, XEWorld, DynamicWAM, Qwen-RobotWorld, ViTacWorld, World Action Planner, VisualPatchWorld, GAUGE, vla-evaluation-harness | The ecosystem began treating orchestration, memory, recovery, skill discovery, physical autoresearch, cross-embodiment schemas, asynchronous serving, runtime verification, planner-facing world models, physical-fidelity diagnosis, evaluation, and the harness itself as optimization targets. |
...
| Harness optimization | Self-Harness, Harness-R1, HarnessOpt-Bench, EvoHarness-RL, EnvACE | Trace-grounded, model-specific changes proposed or learned around a fixed target, with budgeted evaluation and auditable candidate selection; or training-time world rehearsal that internalizes environment dynamics. | Evaluation leakage, same-batch reward overfitting, search cost, unsafe editable surfaces, and rollback. |
