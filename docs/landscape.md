...
| 2026 | Self-Harness, Harness-R1, HarnessOpt-Bench, EvoHarness-RL, SHE, Evo-Bench, EnvACE, OpenForgeRL, A²E, ENPIRE, OpenETA, XPolicyLab, Guava, ASPIRE, GaP, Harness VLA, HarnessWAM, HyMeS, In-Context VLA, AtlasVLA, Physical Agency, RoboBRIDGE, Embodied Agents Take Control, HERO, CheckVLA, CoWAM, TempoWAM, SAFECAST, InternVLA-A1, LingBot-VLA 2.0, Qwen robotics models, TurboVLA, Robot-Factored World Models, World Action Models in Real Time, ω-0, GeniWorld, XEWorld, DynamicWAM, PSG-JEPA, Qwen-RobotWorld, ViTacWorld, World Action Planner, VisualPatchWorld, GAUGE, WorldSimProbe, VLA-Arena, RoboGraph, vla-evaluation-harness | The ecosystem began treating orchestration, memory, recovery, skill discovery, physical autoresearch, cross-embodiment schemas, asynchronous serving, runtime verification, planner-facing world models, physical-fidelity diagnosis, evaluation, and the harness itself as optimization targets. |
...
| World-model planning and interaction | V-JEPA 2-AC, DreamerV3, Robot-Factored World Models, Qwen-RobotWorld, ViTacWorld, GeniWorld, World Action Planner, VisualPatchWorld, DynamicWAM, HarnessWAM | Predicts consequences and supports explicit planning, interactive rollouts, augmentation, policy evaluation, deliberation, recovery, or inspectable executable dynamics. | Model bias, conditioning leakage, geometry/calibration drift, code validity, and planning budget. |
